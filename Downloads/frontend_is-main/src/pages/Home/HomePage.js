...
export default function HomePage() {
  ...
  return (
    <div className="home-page" style={{ backgroundColor: bgColor, transition: 'background-color 1s ease-in-out',backgroundImage: `url('/bg2.png')` }}>
      ...
      {/* About Us Section */}
      <section className="about-us-section fadeInUp" style={{

        backgroundColor: bgColor, transition: 'background-color 1s ease-in-out',
